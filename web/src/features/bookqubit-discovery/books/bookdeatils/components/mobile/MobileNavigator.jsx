// src/features/bookqubit-discovery/books/bookdeatils/components/mobile/MobileNavigator.jsx
...
const MobileNavigator = ({
  ...
  const getSectionIcon = (id) => {
    switch (id) {
      ...
      case "news":
        return <FaNewspaper className="w-3.5 h-3.5" />;
      case "blog":
        return <FaBlog className="w-3.5 h-3.5" />;
      case "related":
        return <FaBook className="w-3.5 h-3.5" />;
      case "analytics":
        return <FaChartBar className="w-3.5 h-3.5" />;
      case "tags":
