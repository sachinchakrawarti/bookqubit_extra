// src/features/bookqubit-discovery/books/bookdeatils/components/shared/BookHeader.jsx
...
const BookHeader = ({ book, theme: propTheme }) => {
  ...
  return (
    <div className="book-header-container">
      {/* Book Title */}
      <div className="book-header-title-section">
        <h1
          className={`
            book-header-title
      ...
      <div className="book-header-meta">
        ...
        {/* Rating */}
        <div className="book-header-rating flex items-center">
      ...
      {book.description && (
        <div className="book-header-description">
          <p
            className={`
