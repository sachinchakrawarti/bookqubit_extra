// src/features/bookqubit-discovery/books/bookdeatils/components/sections/BookHighlights.jsx
  ...
  return (
    <div className="book-highlights-container">
      ...
      <div className="book-highlights-header">
        <div className="book-highlights-title-wrapper">
          <span className="book-highlights-icon">⭐</span>
          <h3
            className={`
      ...
      {/* Highlights List */}
      <div className="book-highlights-list">
        {displayHighlights.map((highlight, index) => (
          <div
            ...
            `}
          >
            <div className="book-highlight-content">
              <div className="book-highlight-icon-wrapper">
                {getHighlightIcon(index)}
              </div>
              <div className="book-highlight-text-wrapper">
                <p
                  className={`
                  book-highlight-text
                ...
                <div className="book-highlight-meta">
                  <span
                    className={`
                    book-highlight-number
                    ${theme.textColors?.secondary || "text-gray-500 dark:text-gray-400"}
                  `}
                  >
                    #{index + 1}
