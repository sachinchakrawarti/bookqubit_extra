...
import "./MyLibrary_SideSheet_Desktop.css";

const MyLibrary_SideSheet_Desktop = ({
  isOpen,
  onClose,
  ...
  const [activeView, setActiveView] = useState("shelves"); // 'shelves' or 'all'
    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <>
          {/* Backdrop */}
          <motion.div
            className={`my-library-sidesheet-backdrop ${isDarkMode ? "dark" : ""}`}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          {/* Side Sheet */}
          <motion.div
            className={`my-library-sidesheet ${isDarkMode ? "dark" : ""}`}
            style={{
          ...
          >
            ...
            {/* Header */}
            <div className="my-library-sidesheet-header">
            ...
            {/* Search */}
            <div className="my-library-sidesheet-search">
            ...
            {/* Shelves */}
            <div className="my-library-sidesheet-shelves">
            ...
            {/* Quick Actions */}
            <div className="my-library-sidesheet-quick-actions">
              <button
            ...
            {/* Footer */}
            <div className="my-library-sidesheet-footer">
              <button
...
export default MyLibrary_SideSheet_Desktop;
