/**
 * Academic-Book Controller
 */

class Academic-BookController {
  constructor(academic-BookService) {
    this.service = academic-BookService;
  }
...
export default Academic-BookController;